...
export default ({show, setShow, user, service}) => {
  ...
  const months = dateHelper.months;
  const days = dateHelper.shortWeekDays;
  ...
  }, [days, user, selectedMonth, selectedYear]);
  ...
  const handleFinishClick = async () => {
    if (
      ...
      return Toast('bottom', 'Atenção! Preencha todos os dados.');
    }
  };
